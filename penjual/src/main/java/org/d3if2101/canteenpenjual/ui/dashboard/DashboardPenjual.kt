...
class DashboardPenjual : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.penjualCardProduk.setOnClickListener {
            startActivity(Intent(this@DashboardPenjual, HomeProduk::class.java))
        }

        binding.penjualCardPendapatan.setOnClickListener {
            startActivity(Intent(this@DashboardPenjual, PendapatanActivity::class.java))
        }

        binding.penjualCardOrder.setOnClickListener {
            startActivity(Intent(this@DashboardPenjual, RiwayatActivity::class.java))
        }

        binding.penjualCardRating.setOnClickListener {
            startActivity(Intent(this@DashboardPenjual, RatingActivity::class.java))
        }
    }
